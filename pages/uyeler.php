...
$sql = "SELECT id,name,surname,mail FROM users where rol='ogrenci' and yemekhane_id = ?";
...
$sql_4 = "select id,name,surname
from users
where yemekhane_id = ?";
$params_4 = [$_SESSION['yemekhane_id']];
